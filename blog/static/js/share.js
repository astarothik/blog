!function (t) {
    ...
    var n = {};
    return e.m = t, e.c = n, e.p = "https://yastatic.net/share2/v-1.15.3/", e(0)
}([function (t, e, n) {
    "use strict";
    function i(t) {
    ...
    }, u = n(122), o = i(u), r = n(3), a = n(4), j = i(a), L = n(128), c = i(L), s = n(126), g = i(s), N = n(125), y = i(N), l = (0, r.loadPlugins)(), p = (0, r.getFrameUrl)(), D = new j["default"](window.document), I = new c["default"](window, o["default"].metrika.id), d = o["default"].defaults, A = (0, g["default"])({
        defaults: d,
        plugins: l,
        frameUrl: p,
        metrika: I
    });
    (0, y["default"])(window, function () {
        A(".ya-share2", {reinit: !1})
    }), I.inject(D), window.Ya = window.Ya || {}, window.Ya.share2 = function (t, e) {
        if ("object" === ("undefined" == typeof t ? "undefined" : M(t)) && 1 === t.nodeType)return A(t, e)[0];
        if ("string" == typeof t)return 0 === t.indexOf("#") && (console.log("DEPRECATION: use element id instead of query selector for initialization"), t = t.slice(1)), A("#" + t, e)[0];
    ...
    i.getParams = function (t) {
        ...
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = n.preserveEmpty, M = void 0 !== i && i;
        return t.replace(/{(\w+)}/g, function (t, n) {
            return void 0 !== e[n] ? encodeURIComponent(e[n]) : M ? t : ""
        })
    ...
    e.__esModule = !0, e["default"] = {
        config: {
            ...
            countUrl: "https://graph.facebook.com/?id={url}&access_token={accessToken}&callback={callback}",
    ...
    (function (t) {
        ...
        a.prototype.subscribe = function (t, e) {
            var n = this, i = function (t) {
                var i = M(t.data), u = i.namespace, o = i.action, r = i.payload;
                u === n._namespace && e(o, r)
        ...
        }, a.prototype.publish = function (t, e, n) {
            (n || this._opener).postMessage(JSON.stringify({namespace: this._namespace, action: t, payload: e}), "*")
        }, e["default"] = a
    }).call(e, n(33))
}, function (t, e) {
    "use strict";
        ...
        t.prototype = {
            toHtml: function (t) {
                ...
                if (t !== !1 && null != t)if ("object" != typeof t) this._buf += this._optEscapeContent ? n(t) : t; else if (Array.isArray(t))for (e = 0, o = t.length; e < o; e++)r = t[e], r !== !1 && null != r && this._html(r); else {
                    ...
                    var L, c, s, g = "", N = "", y = !1;
                    if (L = t.attrs)for (e in L)c = L[e],
                        c === !0 ? N += " " + e : c !== !1 && null !== c && void 0 !== c && (N += " " + e + '="' + i(c) + '"');
                    if (j) {
                        ...
                        if (s) {
                            p && (g += " " + this._optJsCls);
                            var T = y || t.js !== !0 ? M(JSON.stringify(s)) : '{"' + l + '":{}}';
                            N += " " + (t.jsAttr || this._optJsAttrName) + "='" + (this._optJsAttrIsJs ? "return " + T : T) + "'"
                        }
                    }
    ...
    function i(t) {
        for (var e = t.split("."), n = [], i = 0; i < e.length; i++) {
            for (var M = e[i]; "\\" === M[M.length - 1];)M = M.slice(0, -1) + ".", M += e[++i];
            n.push(M)
        }
        return n
    }
    ...
    var u = n(2), o = i(u), r = n(131), a = i(r), j = n(1), L = i(j), c = n(3), s = n(4), g = i(s), N = n(117), y = new g["default"](window.document), l = !1
}, , function (t, e) {
    "use strict";
    e.__esModule = !0;
    var n = function (t, e) {
    ...
    var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
    }, r = n(132), a = i(r), j = n(5), L = i(j), c = n(130), s = i(c), g = n(123), N = i(g), y = n(124), l = n(1), p = i(l), D = n(129), I = i(D), d = n(117), A = n(32), S = i(A), T = new s["default"](window, screen), z = function () {
        function t(e, n) {
            M(this, t);
            var i = n.plugins, o = n.defaults, r = n.options, a = n.frameUrl, j = n.metrika, L = p["default"].getDataset(e), c = u(i), s = "ya-share2." + Math.random(), g = new S["default"](window, s);
            this._params = n, this._domNode = e, this._messenger = g, this._namespace = s, this._plugins = i, this._options = (0, I["default"])(c, o, L, r);
            var y = this._options.get("theme.lang");
            this._i18n = this._options.get("i18n." + y), this._initLayout(i, a, s), this._bindEvents(g, j), (0, d.addClass)(e, "ya-share2"), (0, d.addClass)(e, "ya-share2_inited"), this._morePopup = N["default"].findInside(this._domNode, {
                block: "ya-share2",
                elem: "popup"
        ...
        return t.prototype._isDestroyed = function () {
            ...
            this._options.merge({content: t}), this._initLayout(this._params.plugins, this._params.frameUrl, this._namespace)
        }, t.prototype.updateContentByService = function (t) {
            if (this._isDestroyed())throw new Error("Could not operate on destroyed block.");
            this._options.merge({contentByService: t}), this._initLayout(this._params.plugins, this._params.frameUrl, this._namespace)
            ...
            var e = this, n = function (n) {
                ...
                url: n("content.url")
            }, M = this._plugins[t].contentOptions || {};
            ...
            M.update(this._domNode, "container", [{
                urls: {content: this._options.get("content.url"), frame: e},
            ...
            this._onBodyClick = this._onBodyClick.bind(this, e), this._onKeydown = this._onKeydown.bind(this), p["default"].on(document.body, "click", this._onBodyClick), p["default"].on(document.body, "keydown", this._onKeydown), t.subscribe(this, function (t) {
                ...
                }, n._frame.contentWindow); else if ("counter" === t) {
                    var i = e.service, M = e.count;
                    n.setCount(i, M)
                }
            })
            ...
            return this._services.reduce(function (e, n) {
                var i = n.name, M = t._getContentForService(i), u = t._plugins[i].config.countUrl;
                return u && (e[i] = {url: L["default"].applyTemplate(u, M, {preserveEmpty: !0})}), e
            }, {})
            ...
            if (i) {
                ...
                if (M && (this._options.get("hooks.onshare").call(this, M.name), !this._isDestroyed())) {
                    if (this.setCount(M.name), M.popupDimensions) {
                        ...
                        p["default"].preventDefault(t), p["default"].stopPropagation(t), T.open("yaShare2Popup", u.href, M.popupDimensions)
                    }
    ...
    function u(t) {
        ...
        var n = new j["default"], i = {
            container: function (t) {
                var n = t.urls, i = t.theme, M = t.services, u = t.namespace;
                return {
                    mods: {size: i.size},
                    content: [e("list", i.direction, M, i.limit, n.content, i.copy, i.popupDirection), i.counter && e("iframe", n.frame, u)]
                }
            }, list: function (t, n) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : n.length, M = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "", u = arguments[4], o = arguments[5];
                i === !1 && (i = n.length);
                ...
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "last", M = arguments[3], u = arguments[4], o = e("list", "vertical", t);
                ...
                var n = c["default"].serializeParams({namespace: e});
                return {
                    tag: "iframe",
                    attrs: {src: t + "?" + n, style: "border: 0; display: none;position: absolute; left: -9999px;"}
                }
            }
        };
        return {
